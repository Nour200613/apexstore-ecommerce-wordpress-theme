...
<head>
  ...
  <meta name="description" content="Refund Policy - eedii. Information regarding digital product refunds.">
  <title>Refund Policy – eedii</title>
...
<body>
  ...
  <main class="policy-page">
    <div class="policy-container">
      ...
      <p class="policy-subtitle">Since our products are digital downloads, all sales are final, non-refundable, and
        non-exchangeable.</p>

      <section class="policy-section">
        <p>Please review product descriptions carefully before purchasing. Once a template has been delivered, we cannot
          offer refunds, cancellations, or exchanges.</p>
      </section>

      <section class="policy-section">
        <h2>Exceptions may apply only in cases of:</h2>
        <ul>
          <li>Duplicate purchases (accidental double checkout).</li>
        </ul>
      </section>

      <section class="policy-section">
        <p>For assistance, contact us at <a href="mailto:contact@eedii.com">contact@eedii.com</a> within 7 days of
          purchase.</p>
      </section>
    </div>
  </main>
