...
<head>
  ...
  <title>eedii – Premium Digital Templates</title>
...
<body>
    ...
    <div class="header-container">
      <div class="header-left-group">
        ...
        <nav class="desktop-nav">
          <a href="<?php echo esc_url(home_url('/home/')); ?>" class="active">Home</a>
  ...
  <section class="bestsellers-section" id="catalog" style="padding-top: 32px;">
    <h1 class="section-title fade-in" style="margin-top: 20px;">Welcome to eedii Premium Products</h1>
    <p class="section-subtitle fade-in">Browse our premium digital templates and planners</p>
  ...
  <!-- ═══════════════════════════════════════════
       CUSTOMER REVIEWS SECTION (Consolidated)
       ═══════════════════════════════════════════ -->
  <section class="reviews-section" id="reviews" style="padding: 60px 20px; background: #fdfdfd;">
    <h2 class="section-title fade-in">What Our Customers Say</h2>


    <!-- Review Images Grid -->
    <div class="reviews-images"
      style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 24px; max-width: 1000px; margin: 0 auto;">
      <div class="review-image-card fade-in">
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/p1-10.jpeg" alt="Customer Review 1">
      </div>
      <div class="review-image-card fade-in">
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/p1-11.jpeg" alt="Customer Review 2">
      </div>
      <div class="review-image-card fade-in">
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/p2-review1.jpeg" alt="Customer Review 3">
      </div>
      <div class="review-image-card fade-in">
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/p2-review2.jpeg" alt="Customer Review 4">
      </div>
      <div class="review-image-card fade-in">
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/p3-review1.jpeg" alt="Customer Review 5">
      </div>
      <div class="review-image-card fade-in">
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/p3-review2.jpeg" alt="Customer Review 6">
      </div>
    </div>
  </section>
